...
<Body>
      ...
      <Section>
        <Content>
          <H2>Quem somos ?</H2>
          <Paragraph>
            João Pedro Lima, Guilherme Alves e Gustavo fundaram a TrackSuit com o objetivo de alinhar a programação, tecnologia e o trabalho social no cotidiano popular. Para os fundadores, no mercado atual está em escassez empresas que trabalhem para um bem maior.
          </Paragraph>
        </Content>
        <Link to="/">
          <Logo>
    ...
    <path d="M167.001 54.6642H161.638V71.8369H155.677V54.6642H150.3V48.996H167.006V54.6642H167.001Z" fill="#FAF9F9" />
      ...
      <main>
        <LinkedIn>
          <Content>
            <H2>Guilherme Alves de Oliveira e Oliveira</H2>
            <Paragraph>
              Guilherme é estudante de ciências da computação na FECAP, com 19 anos já trabalhou 1 ano na wizard, atualmente trabalha como professor particular de inglês e é estagiário na empresa VDX AI.
            </Paragraph>
          </Content>
          <Link to="https://www.linkedin.com/in/guilherme-alves-de-oliveira-e-oliveira-173365278/" target="_blank"><LinkedInLogo src={LogoLinkedin} alt="linkedin Guilherme" /></Link>
        </LinkedIn>
      </main>
      <main>
        <LinkedIn>
          <Content>
            <H2>João Pedro Lima Paulo</H2>
            <Paragraph>
              Estudante de Ciência da Computação na Fundação Alvares Penteado. Atualmente com 19 anos. E estágiando na CREDIKASA.
            </Paragraph>
          </Content>
          <Link to="https://www.linkedin.com/in/joãopedro-lima28/" target="_blank"><LinkedInLogo src={LogoLinkedin} alt="linkedin Joao Pedro" /></Link>
        </LinkedIn>
      </main>
      <main>
        <LinkedIn>
          <Content>
            <H2>Gustavo Marcello Correa De Araujo</H2>
            <Paragraph>
              Estudante de Ciência da Programação na FECAP, inglês fluente e buscando colocação no mercado de trabalho.
            </Paragraph>
          </Content>
          <Link to="https://www.linkedin.com/in/gustavo-araujo-4177b029b/" target="_blank" ><LinkedInLogo src={LogoLinkedin} alt="linkedin Gustavo" /></Link>
        </LinkedIn>
      </main>
    </Body>
    )
